 ...
 */
public class GetMovieFromLOD extends UseCase<Movie, GetMovieFromLOD.Params> {
  public static final String NAME = "MOVIE_LOD";

  private final MovieRepository repository;

  @Inject
  public GetMovieFromLOD(MovieRepository repository,
  ...
  public Observable<Movie> buildUseCaseObservable(Params params) {
    ...
    return this.repository.movieFromLOD(params.title);
  }
