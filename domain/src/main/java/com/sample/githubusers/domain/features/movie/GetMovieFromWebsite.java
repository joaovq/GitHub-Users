 ...
 */
public class GetMovieFromWebsite extends UseCase<Movie, GetMovieFromWebsite.Params> {
  public static final String NAME = "MOVIE_WEB";

  private final MovieRepository repository;

  @Inject
  public GetMovieFromWebsite(MovieRepository repository,
  ...
  public Observable<Movie> buildUseCaseObservable(Params params) {
    ...
    return this.repository.movieFromWebsite(params.title);
  }
